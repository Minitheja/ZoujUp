...
export const translations = {
  en: {
    ...
    footer: {
      ...
      companyLinks: ["About", "Features", "Works"],
      productLinks: ["Updates", "Help"],
      supportLinks: ["FAQ", "Privacy Policy", "Terms", "Contact"],
    },
  },
  ...
  fr: {
    ...
    footer: {
      ...
      product: "Produit",
      support: "Support",
      crafted: "Conçu avec soin.",
      companyLinks: ["À propos", "Fonctionnalités", "Fonctionnement"],
      productLinks: ["Mises à jour", "Aide"],
      supportLinks: ["FAQ", "Confidentialité", "Conditions", "Contact"],
    },
  },
  ...
  es: {
    ...
    footer: {
      ...
      product: "Producto",
      support: "Soporte",
      crafted: "Creado con esmero.",
      companyLinks: ["Acerca de", "Características", "Cómo funciona"],
      productLinks: ["Actualizaciones", "Ayuda"],
      supportLinks: ["FAQ", "Política de Privacidad", "Términos", "Contact"],
    },
  },
} as const;
