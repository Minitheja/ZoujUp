...
function PrivacyPolicy() {
  ...
  return (
    <div className="relative min-h-screen bg-white overflow-x-hidden" dir="rtl">
      ...
      <main className="pt-24 sm:pt-32 pb-16 sm:pb-24">
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          <h1 className="text-4xl sm:text-5xl font-bold text-[#1A1A1A] mb-2 font-display">
            سياسة الخصوصية
          </h1>

          <p className="text-sm text-[#6B7280] mb-10 italic">
            آخر تحديث: ماي 2026
          </p>
          ...
          <div className="space-y-10 text-[#1A1A1A]">
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold uppercase tracking-wide text-[#FFC107]">
                1. شكون حنا
              </h2>
              ...
              <p className="leading-relaxed">
                ZoujUp
                <br />
                هو تطبيق موبايل لتعلّم وممارسة اللغات، مازال تحت التطوير.
                <br />
                للتواصل:
                {" "}
                <a
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold uppercase tracking-wide text-[#FFC107]">
                2. شنو المعطيات اللي كنجمعو
              </h2>

              <div className="leading-relaxed space-y-1">
                <p>منين كتسجل فـ لائحة الانتظار ديالنا، كنجمعو:</p>

                <ul className="list-disc pr-6 space-y-1">
                  <li>عنوان البريد الإلكتروني ديالك</li>
                  <li>اللغة الأم ديالك</li>
                  <li>اللغة اللي بغيتي تمارسها</li>
                </ul>
              </div>
            </section>
            ...
            <section className="space-y-3">
              ...
              <div className="leading-relaxed space-y-1">
                ...
                <ul className="list-disc pr-6 space-y-1">
                  <li>
                    نعلموك ملي يطلق ZoujUp ونبعتو لك معلومات على الولوج المبكر
                  </li>

                  <li>
                    نفهمو الحاجات اللغوية ديال المجتمع ديالنا باش نضمنو تواصل
                    ومطابقات ذات جودة من أول يوم
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p className="leading-relaxed">
                الإيميل ديالك كيتخزن بطريقة آمنة عبر منصة ديال الإيميلات
                (بحال Mailchimp أو ما شابه).
                <br />
                ما كنخزنو حتى معطيات شخصية أخرى.
              </p>
            </section>

            <section className="space-y-3">
              <h2 className="text-xl font-bold uppercase tracking-wide text-[#FFC107]">
                5. شحال كنبقاو محتافظين بها
              </h2>

              <p className="leading-relaxed">
                كنحتافظو بالإيميل ديالك حتى للإطلاق ديال التطبيق.
                <br />
                تقدر تطلب حذفه فـ أي وقت.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p className="leading-relaxed">
                عندك الحق تطلع، تصحح، أو تحذف معطياتك فـ أي وقت.
                <br />
                باش تدير هاد الشي، صيفط لينا إيميل على:
                {" "}
                <a
                  href="mailto:contact@zoujup.com"
                  className="text-[#FFC107] hover:underline"
            ...
            <section className="space-y-3">
              <h2 className="text-xl font-bold uppercase tracking-wide text-[#FFC107]">
                7. ما كنبيعوش معطياتك نهائياً
              </h2>

              <p className="leading-relaxed">
                ما غاديش نشاركو ولا نبيعو الإيميل ديالك لأي طرف ثالث.
              </p>
            </section>
            ...
            <section className="space-y-3">
              ...
              <p className="leading-relaxed">
                هاد الموقع ما كيستعملش الكوكيز ديال التتبع فهاد المرحلة.
              </p>
            </section>
